...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A robust freelancer marketplace platform connecting businesses with skilled professionals. Features real-time websocket messaging, automated matching, and dashboard analytics.',
